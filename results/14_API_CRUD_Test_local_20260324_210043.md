...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 76, NIK: 9900001774357270 |
| ✅ | GET /taxpayers/76 → 200 |
| ✅ | GET /taxpayers/search/9900001774357270 → 200 |
| ✅ | UPDATE taxpayer/76 → 200 |
| ✅ | DELETE taxpayer/76 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 15 |
| ✅ | GET /retribution-types/15 → 200 |
| ✅ | UPDATE retribution-type/15 → 200 |
| ✅ | DELETE retribution-type/15 → 200 |
