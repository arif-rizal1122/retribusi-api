...
- **CORS:** Diatur ketat di sisi Nginx dan Laravel agar hanya domain resmi (`*.sipanda.online`) yang bisa mengakses API.
- **Branding PWA:** Nama aplikasi telah diperbarui menjadi **M-PAD** dengan ikon yang dioptimalkan sesuai standar PWA (192x192, 512x512).
...
---
*Dokumen ini diperbarui secara berkala. Terakhir diperbarui: 26 Februari 2026.*
