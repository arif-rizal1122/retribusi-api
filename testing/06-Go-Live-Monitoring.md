...
- **Instruksi**: Sang Administrator Backend (Tim Anda) wajib bersiaga membuka _Console SSH Client_ terkoneksi ke IP Publik VPS Anda `157.10.252.74`. Masuk sebagai user `sipanda` atau `root`.
