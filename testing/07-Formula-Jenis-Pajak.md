...
Aplikasi SIPANDA memiliki puluhan jenis pungutan pajak dengan struktur *form* dan rumus hitung (*formula*) yang saling berbeda-beda sesuai Perwali 58/2024. Modul ini bertujuan menguji keakuratan matematis mesin *Calculator* API.
