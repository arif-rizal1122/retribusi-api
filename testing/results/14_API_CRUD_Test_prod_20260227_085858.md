...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 1347, NIK: 9900001772153953 |
| ✅ | GET /taxpayers/1347 → 200 |
| ✅ | GET /taxpayers/search/9900001772153953 → 200 |
| ✅ | UPDATE taxpayer/1347 → 200 |
| ✅ | DELETE taxpayer/1347 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 56 |
| ✅ | GET /retribution-types/56 → 200 |
| ✅ | UPDATE retribution-type/56 → 200 |
| ✅ | DELETE retribution-type/56 → 200 |
