...
Last login: Tue Apr 14 04:36:06 2026 from 180.251.145.115
-bash: /usr/lib/command-not-found: /usr/bin/python3: bad interpreter: No such file or directory
sipanda@sipanda:~$ sudo mysql <<'EOF'
> <panda'@'localhost' IDENTIFIED BY 'MpadSecure2026!';
> FLUSH PRIVILEGES;
> EOF
sipanda@sipanda:~$ <retribusi-api-staging && php artisan migrate:status
...
sipanda@sipanda:~/retribusi-api-staging$ <i && php testing/run_role_e2e_test.php prod petugas
