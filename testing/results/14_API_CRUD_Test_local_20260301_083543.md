...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 38, NIK: 9900001772325358 |
| ✅ | GET /taxpayers/38 → 200 |
| ✅ | GET /taxpayers/search/9900001772325358 → 200 |
...
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 53 |
| ✅ | GET /retribution-types/53 → 200 |
| ✅ | UPDATE retribution-type/53 → 200 |
| ✅ | DELETE retribution-type/53 → 200 |
