...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 39, NIK: 9900001772325838 |
| ✅ | GET /taxpayers/39 → 200 |
| ✅ | GET /taxpayers/search/9900001772325838 → 200 |
| ✅ | UPDATE taxpayer/39 → 200 |
| ✅ | DELETE taxpayer/39 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 54 |
| ✅ | GET /retribution-types/54 → 200 |
| ✅ | UPDATE retribution-type/54 → 200 |
| ✅ | DELETE retribution-type/54 → 200 |
