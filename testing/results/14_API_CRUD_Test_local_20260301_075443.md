...
| ❌ | GET /pengawas/anomalies → 500 (expected 200) |
...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 35, NIK: 9900001772322939 |
| ✅ | GET /taxpayers/35 → 200 |
| ✅ | GET /taxpayers/search/9900001772322939 → 200 |
...
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 50 |
| ✅ | GET /retribution-types/50 → 200 |
| ✅ | UPDATE retribution-type/50 → 200 |
| ✅ | DELETE retribution-type/50 → 200 |
