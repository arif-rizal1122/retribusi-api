...
| ✅ | Citizen ID: 4, NIK: 1234567890123456 |
...
| ✅ | GET /citizen/services/38 (detail) → 200 |
| ✅ | GET /citizen/services/38/bills → 200 |
...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 40, NIK: 9900001772325955 |
| ✅ | GET /taxpayers/40 → 200 |
| ✅ | GET /taxpayers/search/9900001772325955 → 200 |
| ✅ | UPDATE taxpayer/40 → 200 |
| ✅ | DELETE taxpayer/40 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 55 |
| ✅ | GET /retribution-types/55 → 200 |
| ✅ | UPDATE retribution-type/55 → 200 |
| ✅ | DELETE retribution-type/55 → 200 |
...
| St | Detail |
|----|--------|
| ✅ | READ profile → name: Budi Santoso
