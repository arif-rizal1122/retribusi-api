...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 1395, NIK: 9900001772681608 |
| ✅ | GET /taxpayers/1395 → 200 |
| ✅ | GET /taxpayers/search/9900001772681608 → 200 |
| ✅ | UPDATE taxpayer/1395 → 200 |
| ✅ | DELETE taxpayer/1395 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 61 |
| ✅ | GET /retribution-types/61 → 200 |
| ✅ | UPDATE retribution-type/61 → 200 |
| ✅ | DELETE retribution-type/61 → 200 |
