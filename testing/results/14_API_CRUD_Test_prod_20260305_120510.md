...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 1396, NIK: 9900001772683624 |
| ✅ | GET /taxpayers/1396 → 200 |
| ✅ | GET /taxpayers/search/9900001772683624 → 200 |
| ✅ | UPDATE taxpayer/1396 → 200 |
| ✅ | DELETE taxpayer/1396 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 62 |
| ✅ | GET /retribution-types/62 → 200 |
| ✅ | UPDATE retribution-type/62 → 200 |
| ✅ | DELETE retribution-type/62 → 200 |
