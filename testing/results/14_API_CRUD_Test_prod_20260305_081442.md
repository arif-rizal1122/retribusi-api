...
| St | Detail |
|----|--------|
| ✅ | CREATE taxpayer → ID: 1394, NIK: 9900001772669697 |
| ✅ | GET /taxpayers/1394 → 200 |
| ✅ | GET /taxpayers/search/9900001772669697 → 200 |
| ✅ | UPDATE taxpayer/1394 → 200 |
| ✅ | DELETE taxpayer/1394 → 200 |

### 6. CRUD Lifecycle: Retribution Type
| St | Detail |
|----|--------|
| ✅ | CREATE retribution-type → ID: 60 |
| ✅ | GET /retribution-types/60 → 200 |
| ✅ | UPDATE retribution-type/60 → 200 |
| ✅ | DELETE retribution-type/60 → 200 |
